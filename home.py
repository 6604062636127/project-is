...
if page == "Home":
    ...
    st.markdown("""
    <p class="written">เว็บไซต์นี้เป็นแพลตฟอร์มสำหรับการศึกษาและทดลองเกี่ยวกับ Machine Learning (ML) และ Neural Networks (NN) </p>""", unsafe_allow_html=True)
    st.markdown("""
    <p class="written">สามารถดูเอกสารเกี่ยวกับ Machine Learning และ Neural Networks รวมถึงทดลองใช้งานโมเดลที่พัฒนาขึ้นมาได้จากเมนูด้านบน</p>""", unsafe_allow_html=True)
